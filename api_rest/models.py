...
class Computer(models.Model):
    ...
    organization_id = models.CharField(max_length=10, blank=True, null=True)
    location_id = models.CharField(max_length=10, blank=True, null=True)
    brand_id = models.CharField(max_length=10, blank=True, null=True)
    model_id = models.CharField(max_length=10, blank=True, null=True)
    osfamily_id = models.CharField(max_length=10, blank=True, null=True)
    type = models.CharField(max_length=30, blank=True, null=True)
    cpu = models.CharField(max_length=50, blank=True, null=True)
    os_version_id = models.CharField(max_length=10, blank=True, null=True)
